...
public class AventurinePanel extends JPanel {

    public AventurinePanel() {
        ...
        // Title Label
        JLabel titleLabel = new JLabel("<html><div style='font-size:12px; color:#DFDFDF;'>HONKAI: STAR RAIL<br></div><div style='font-size:36px; color:#E6D863;'>Aventurine</div></html>");
        ...
        ParallelogramPanel parallelogram = new ParallelogramPanel(new Color(0xE6D863));
        parallelogram.setBounds(30, 27, 184, 110); // Parallelogram position

        // Image label
        ImageIcon acheronImage = new ImageIcon("./app/src/main/resources/images/aventurine.png");
        ...
        introText.setText("""
            ...
            <b style='color:#E6D863;'>Aventurine</b> is a <b style='color:#C9A36A;'>5★</b> character from the <b style='color:#E6D863;'>Imaginary</b> element who follows the <b style='color:#E2A43D;'>Path of Preservation</b>.<br><br>
            ...
            He won his current position by wagering against fate itself. He views life as a high-stakes, high-return investment, and he plays this particular gamble 
            with masterful ease.
            </body></html>
        """);
