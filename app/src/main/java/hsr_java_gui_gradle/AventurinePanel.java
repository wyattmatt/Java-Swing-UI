...
public class AventurinePanel extends JPanel {
    ...
    public AventurinePanel() {
        ...
        // Title Label
        JLabel titleLabel = new JLabel("<html><div style='font-size:12px; color:#DFDFDF;'>HONKAI: STAR RAIL<br></div><div style='font-size:36px; color:#B85EFF;'>Aventurine</div></html>");
        ...
        introText.setText("""
            ...
            <b style='color:#B85EFF;'>Aventurine</b> is a <b style='color:#FFD700;'>5★</b> character from the <b style='color:#B85EFF;'>Imaginary</b> element who follows the <b>Path of Preservation</b>.<br><br>
