...
public class CastoricePanel extends JPanel {
    ...
    public CastoricePanel() {
        ...
        // Title Label
        JLabel titleLabel = new JLabel("<html><div style='font-size:12px; color:#DFDFDF;'>HONKAI: STAR RAIL<br></div><div style='font-size:36px; color:#B85EFF;'>Castorice</div></html>");
        ...
        introText.setText("""
            ...
            <b style='color:#B85EFF;'>Castorice</b> is a <b style='color:#FFD700;'>5★</b> character from the <b style='color:#B85EFF;'>Quantum</b> element who follows the <b>Path of Remembrance</b>.<br><br>
