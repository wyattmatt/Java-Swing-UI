...
public class CastoricePanel extends JPanel {

    public CastoricePanel() {
        ...
        // Title Label
        JLabel titleLabel = new JLabel("<html><div style='font-size:12px; color:#DFDFDF;'>HONKAI: STAR RAIL<br></div><div style='font-size:36px; color:#7E74EB;'>Castorice</div></html>");
        ...
        // Image label
        ImageIcon acheronImage = new ImageIcon("./app/src/main/resources/images/castorice.png");
        ...
        introText.setText("""
            ...
            <b style='color:#7E74EB;'>Castorice</b> is a <b style='color:#C9A36A;'>5★</b> character from the <b style='color:#7E74EB;'>Quantum</b> element who follows the <b>Path of Remembrance</b>.<br><br>
