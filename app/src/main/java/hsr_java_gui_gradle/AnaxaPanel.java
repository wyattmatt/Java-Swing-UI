...
public class AnaxaPanel extends JPanel {
    ...
    public AnaxaPanel() {
        ...
        // Title Label
        JLabel titleLabel = new JLabel("<html><div style='font-size:12px; color:#DFDFDF;'>HONKAI: STAR RAIL<br></div><div style='font-size:36px; color:#B85EFF;'>Anaxa</div></html>");
        ...
        introText.setText("""
            ...
            <b style='color:#B85EFF;'>Anaxa</b> is a <b style='color:#FFD700;'>5★</b> character from the <b style='color:#B85EFF;'>Wind</b> element who follows the <b>Path of Erudition</b>.<br><br>
