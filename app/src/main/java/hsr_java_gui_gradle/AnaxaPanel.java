...
public class AnaxaPanel extends JPanel {
    ...
    public AnaxaPanel() {
        ...
        // Title Label
        JLabel titleLabel = new JLabel("<html><div style='font-size:12px; color:#DFDFDF;'>HONKAI: STAR RAIL<br></div><div style='font-size:36px; color:#61CF93;'>Anaxa</div></html>");
        ...
        // Image label
        ImageIcon acheronImage = new ImageIcon("./app/src/main/resources/images/anaxa.png");
        ...
        introText.setText("""
            ...
            <b style='color:#61CF93;'>Anaxa</b> is a <b style='color:#C9A36A;'>5★</b> character from the <b style='color:#61CF93;'>Wind</b> element who follows the <b style='color:#C65ADE;'>Path of Erudition</b>.<br><br>
            The Grove of Epiphany, where knowledge flourishes and philosophers are born. Yet here stands Anaxagoras the blasphemer, the Chrysos Heir who challenges 
            the Coreflame of Reason: Would you truly embrace infamy and defy prophecy, driving the thorns of doubt into the Sacred Tree of wisdom?
            </body></html>
        """);
