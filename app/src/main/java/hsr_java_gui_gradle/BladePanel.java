...
public class BladePanel extends JPanel {
    ...
    public BladePanel() {
        ...
        // Title Label
        JLabel titleLabel = new JLabel("<html><div style='font-size:12px; color:#DFDFDF;'>HONKAI: STAR RAIL<br></div><div style='font-size:36px; color:#61CF93;'>Blade</div></html>");
        ...
        // Image label
        ImageIcon acheronImage = new ImageIcon("./app/src/main/resources/images/blade.png");
        ...
        introText.setText("""
            ...
            <b style='color:#61CF93;'>Blade</b> is a <b style='color:#C9A36A;'>5★</b> character from the <b style='color:#61CF93;'>Wind</b> element who follows the <b style="color:#E6D863;">Path of Destruction</b>.<br><br>
            A swordsman who abandoned his body to become a blade. Birth name unknown. He pledges loyalty to Destiny's Slave, and possesses a terrifying self-healing ability. 
